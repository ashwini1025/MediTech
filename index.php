    ...
    <header class="header black-bg">
      ...
      <a href="index.html" class="logo"><b>MEDI<span>TECH</span><img src="img/LOGO.png" height="50" width="50"></b>  <b align="center"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;WELCOME TO DOCTORS PORTAL </b></a>
        ...
        <ul class="nav pull-right top-menu">
            ...
            <li> <h3 align="right"><?php $timestamp = time();  echo "\n";  echo(date("F d, Y h:i:s A", $timestamp));  ?></h3></li>
           <li><?php echo " Name :".$_SESSION['user']."" ?><a class="logout" href="login.php"> Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
